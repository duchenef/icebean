...
var messageOfDay = "<h4>assignFAST Details</h4>\
                    ...
                    <p>Start typing, and suggested See also and Authorized headings will appear.</p>\
						  ...
						  <p>The data is available as a Web Service, and the javascript can be easily \
						  added to a cataloging interface to allow easy selection of controlled FAST headings.\
						  In this way, even the cut and paste can be eliminated.  See the <a href=\"http://www.oclc.org/developer/develop/web-services/fast-api.en.html\">API</a> on the OCLC Developers Network for details.</p>"
var TODO         = "<h4>TODO</h4>\
                    <ul>\
...
var addInfo         = "<h4>Additional Information</h4>\
						  ...
						  <p>You can learn more about the FAST project by visiting the FAST project\
						   home page at: <a href=\"http://www.oclc.org/research/activities/fast/default.htm\">\
							http://www.oclc.org/research/activities/fast/default.htm</a></p>"; //only visible on entry page
...
var footerNewsx     = '<div class="foot-news"><div class="foot-sec"> \
                    <h2 class="newstitle">FAST News</h2> \
                   <dl> \
                   <dt><span style="font-weight: bold;">December 2015</span></dt> \
                   <dd><ul class="bulleted"> \
                   <li> All FAST Services will be unavailable on Wednesday, December 2, starting at 9 PM EST.  This is a maintenance outage and is expected to last about two hours.  \
                   </li>  \
                   </ul></dd>  \
                   </dl>  \
                   </div></div>'						  
var lastUpdate="The most recent update for FAST was 4/12/2016. The FAST database will be updated periodically. Our target is to update FAST at least twice each year.";
var projectTitle = mastheadTitle;
var comments = "<h4>For comments on assignFAST contact the <a href=\"http://www.oclc.org/research/forms/feedback-form.html?project=assignFAST\" target=\"_blank\" >FAST Team</a></h4>";
